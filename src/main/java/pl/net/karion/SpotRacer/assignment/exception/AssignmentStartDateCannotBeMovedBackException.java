...
public class AssignmentStartDateCannotBeMovedBackException extends RuntimeException {
    ...
    public static final String ASSIGNMENT_START_DATE_CANNOTBEMOVED_BACK = "Assignment start date cannot be moved back.";
    ...
    public AssignmentStartDateCannotBeMovedBackException() {
        super(ASSIGNMENT_START_DATE_CANNOTBEMOVED_BACK);
    }
}
